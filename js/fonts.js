...
(function() {
	...
	if( sessionStorage.foftFontsLoaded ) {
		document.documentElement.className += " fonts-loaded fonts-b-loaded";
		return;
	}
	...
	var LatoRegular = new FontFaceObserver('LatoRegular');
	...
	Promise.all([
		...
		var LatoBold = new FontFaceObserver('LatoBold', {
			weight: 700
		});

		var LatoThin = new FontFaceObserver('LatoThin', {
			weight: 300
		});

		var LatoBlack = new FontFaceObserver('LatoBlack', {
			weight: 900
		});

		var LatoLight = new FontFaceObserver('LatoLight', {
			weight: 300
		});
