 ...
 * Table of contents: 
 * main.js
 * Generated by MagicMin: 2020-03-10 02:58:49
 */
$(document).ready(function(){let dropdown=document.querySelector('.dropdown');dropdown.addEventListener('click',function(event){event.stopPropagation();dropdown.classList.toggle('is-active');$('.icon').toggleClass('rotat');});let hello=document.querySelector('.hello');hello.addEventListener('click',function(event){event.stopPropagation();hello.classList.toggle('is-active');$('.icon').toggleClass('rotat');});let world=document.querySelector('.world');world.addEventListener('click',function(event){event.stopPropagation();world.classList.toggle('is-active');$('.icon').toggleClass('rotat');});if(cargarPlugin('tabs')){cargarRecursos([{tipo:'js',src:'js/jquery.tabs/jquery.tabs.min.js'},],function(){$(window).resize(function(){if($(window).width()>990){if(window.tabs===undefined){window.tabs=$('.tab-seccion').tabs({autoRotate:2500,alwaysScrollToTop:false});}}else{if(window.tabs!==undefined){$('.tab-seccion').destroyTabs();window.tabs=undefined;}}}).resize();});if($(window).width()<990){$(".mobile-tittle").click(function(e){$(".mobile-tittle").removeClass('selected');$(this).addClass('selected');var desplegable=$(this).next();$('.js-cont-desplegable').not(desplegable).slideUp('fast');desplegable.slideToggle('fast');});}}
if(cargarPlugin('owlCarousel')){cargarRecursos([{tipo:'css',src:'js/jquery.owl-carousel/assets/owl.carousel.min.css'},{tipo:'css',src:'js/jquery.owl-carousel/assets/animate.min.css'},{tipo:'js',src:'js/jquery.owl-carousel/owl.carousel.min.js'},],function(){$('.slider-principal > ul').owlCarousel({items:3,loop:true,autoplay:true,autoplayTimeout:6000,slideSpeed:100,nav:true,dots:true,dotsContainer:'.dotsCont',navText:["<i class=\"icon-left-open icon\"></i><span class=\"nav-slider-prev\">Anterior</span>","<i class=\"icon-right-open icon\"></i><span class=\"nav-slider-next\">Siguiente</span>"],responsive:{0:{items:1},550:{items:2},767:{items:3},},});$('.slider-novedad > ul').owlCarousel({autoplay:false,items:1,loop:true,slideSpeed:1000,autoplaySpeed:500,singleItem:true,dragBeforeAnimFinish:false,mouseDrag:false,touchDrag:true,nav:true,dots:false,navText:["<i class=\"icon-left-open icon\"></i><span>Anterior</span>","<i class=\"icon-right-open icon\"></i><span>Siguiente</span>"],});});}
$(document).ready(function(){$(".navbar-burger").click(function(){$(".navbar-burger").toggleClass("is-active");$(".navbar-menu").toggleClass("is-active");});});if(cargarPlugin('slick')){cargarRecursos([{tipo:'css',src:'js/jquery.slick/jquery.slick.css'},{tipo:'js',src:'js/jquery.slick/jquery.slick.min.js'},],function(){$('.slider-marcas').slick({infinite:true,slidesToShow:3,slidesToScroll:6,dots:false,arrows:false,autoplay:true,autplaySpeed:1000,speed:40000,cssEase:'linear',pauseOnHover:false,responsive:[{breakpoint:992,settings:{slidesToShow:5,slidesToScroll:5}},{breakpoint:768,settings:{slidesToShow:4,slidesToScroll:4,speed:4000,}},{breakpoint:480,settings:{centerMode:true,slidesToShow:1,slidesToScroll:1,dots:false,speed:1500,}}]});$('.slider-ficha').slick({slidesToShow:1,slidesToScroll:1,arrows:false,fade:true,asNavFor:'.nav-ficha',lazyLoad:'ondemand',});$('.nav-ficha').slick({slidesToShow:6,slidesToScroll:1,arrows:true,dots:false,asNavFor:'.slider-ficha',centerMode:true,focusOnSelect:true,responsive:[{breakpoint:768,settings:{slidesToShow:3}},{breakpoint:480,settings:{slidesToShow:2}},{breakpoint:380,settings:{slidesToShow:2}}]});});}
...
$(function(){$('html').addClass('active');$('a[href]').each(function(){if(location.hostname===this.hostname||!this.hostname.length){var link=$(this).attr("href");if(link.match("^#")){$(this).click(function(){var target=$(link);target=target.length?target:$('[name='+this.hash.slice(1)+']');if(target.length){$('html,body').animate({scrollTop:target.offset().top-70},1000);return false;}});}else if(link.match("^mailto")){}else{$(this).click(function(e){e.preventDefault();$('html').removeClass('active');setTimeout(function(){window.location=link;},500);});}}});});$(window).scroll(function(){var $cabecera=$('.cabecera');if($(window).scrollTop()>20){$cabecera.addClass('scroll');}else{$cabecera.removeClass('scroll');}});var $cabecera=$('.cabecera');var previousScroll=0;$(window).scroll(function(event){var scroll=$(this).scrollTop();if(scroll>previousScroll&&scroll>400){$cabecera.addClass('ocultar');$(".navbar-collapse").removeClass("in").addClass("collapse");$(".hamburger").removeClass("is-active");}else{$cabecera.removeClass('ocultar');}
previousScroll=scroll;});$(document).ready(function(){$('.hamburger').click(function(){$(this).toggleClass('is-active');$('.nav-movil').toggleClass('activo');$('#Group-11-Copy-4').toggleClass('activo');});});function cargarPlugin(plugin){return(window.jsplugins.indexOf(plugin)!==-1);}
